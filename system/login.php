...
<body>
    ...
    <div style="max-width: 400px; margin:auto" class="container text-center mt-2 bg-black-color">
      <form style="max-width: 400px; margin:auto">
        ...
        <div class="form-group">
          ...
          <!-- <small id="emailHelpId" class="form-text text-muted">Esqueceu o email?</small> -->
        </div>
        <div class="form-group">
        ...
        <a class="btn btn-primary btn-lg btn-block mt-2 mb-4" href="#" role="button">Enviar</a>
